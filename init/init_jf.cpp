...
void vendor_load_properties()
{
    ...
    if (bootloader.find("M919") == 0) {
        ...
        property_override_dual("ro.build.product", "ro.mk.device", "jfltetmo");
        ...
        property_override_dual("ro.build.product", "ro.mk.device", "jgedlte");
        ...
        property_override_dual("ro.build.product", "ro.mk.device", "jflte");
        ...
        property_override_dual("ro.build.product", "ro.mk.device", "jfltecri");
        ...
        property_override_dual("ro.build.product", "ro.mk.device", "jfltecsp");
        ...
        property_override_dual("ro.build.product", "ro.mk.device", "jflteusc");
        ...
        property_override_dual("ro.build.product", "ro.mk.device", "jfltespr");
        ...
        property_override_dual("ro.build.product", "ro.mk.device", "jfltecan");
        ...
        property_override_dual("ro.build.product", "ro.mk.device", "jflteatt");
        ...
        property_override_dual("ro.build.product", "ro.mk.device", "jfvelte");
        ...
        property_override_dual("ro.build.product", "ro.mk.device", "jfltelra");
        ...
        property_override_dual("ro.build.product", "ro.mk.device", "jfltevzw");
    }
